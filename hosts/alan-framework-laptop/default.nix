  ...
  module = { config, pkgs, pkgs-unstable, ... }: {
    ...
    alanix.users = {
      ...
      accounts.buddia = {
        ...
        authorizedHosts = [ "alan-big-nixos" "alan-framework" "alan-home" "alan-node" "alan-optiplex" "alan-tv" "fife-tv" "randy-big-nixos" ];
    ...
    alanix.opensave = {
      ...
      peers = [ "alan-tv" "alan-big-nixos" "alan-framework" ];
    };
