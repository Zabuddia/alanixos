  ...
  module = { config, pkgs, pkgs-unstable, ... }: {
    ...
    alanix.users = {
      ...
      accounts.buddia = {
        ...
        authorizedHosts = [ "alan-framework" "alan-framework-laptop" "alan-home" "alan-node" "alan-optiplex" "alan-tv" "fife-tv" "randy-big-nixos" ];
    ...
    alanix.opensave = {
      ...
      peers = [ "alan-tv" "alan-framework-laptop" "alan-framework" ];
    };
